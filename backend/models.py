...
"""
Files consisting of database models for our backend application
"""


class Representative(db.Model):
    """
    representative model to represent information about a U.S. representative
    """
    ...
    """
    format the representative data into a dictionary format - to display it
    through an api
    """
    def format(self):
        return {
    ...
    """
    to string method for the representative model
    """
    def __repr__(self):
        return '<Representatives {}: {!r} {}>' \
            .format(self.bioguide, self.firstname, self.lastname,
                    self.party_id, self.state, self.district,
                    self.twitter, self.youtube, self.office,
                    self.votes_with_party_pct, self.url,
                    self.image_uri)


class Bill(db.Model):
    """
    bill model to represent information about recent bills sponsored by a
    U.S. representative
    """
    __tablename__ = 'bill'
    ...
    """
    format the bill data into a dictionary format - to display it
    through an api
    """
    def format(self):
        return {
    ...
    """
    to string method for the bill model
    """
    def __repr__(self):
...
class Article(db.Model):
    """
    article model to represent recent articles about a U.S. representative
    """
    ...
    representative_id = db.Column(db.String(255), db.ForeignKey(
        'representative.bioguide'), nullable=False)

    """
    format the article data into a dictionary format - to display it
    through an api
    """
    def format(self):
        return {
    ...
    """
    to string method for the article model
    """
    def __repr__(self):
        return '<Articles {}: {}>'\
            .format(self.id, self.title, self.site, self.date,
                    self.representative_id)


class State(db.Model):
    """
    state model to represent information about U.S states and corresponding
    districts
    """
    __tablename__ = 'state'
    ...
    """
    format the state data into a dictionary format - to display it
    through an api
    """
    def format(self):
        return {
    ...
    """
    to string method for the state model
    """
    def __repr__(self):
...
class District(db.Model):
    """
    district model to represent information about U.S congressional
    districts
    """
    __tablename__ = 'district'
    alpha_num = db.Column(db.String(11),
    ...
    """
    format the district data into a dictionary format - to display it
    through an api
    """
    def format(self):
        return {
    ...
    """
    to string method for the district model
    """
    def __repr__(self):
...
class PoliticalParty(db.Model):
    """
    political party model to represent information about political parties
    in the U.S.
    """
    ...
    """
    format the political party data into a dictionary format - to display it
    through an api
    """
    def format(self):
        return {
    ...
    """
    to string method for the political party model
    """
    def __repr__(self):
...
class PartyColor(db.Model):
    """
    party color model to represent color information of political parties
    in the U.S.
    """
    ...
    """
    format the party color data into a dictionary format - to display it
    through an api
    """
    def format(self):
        return {
    ...
    """
    to string method for the party color model
    """
    def __repr__(self):
